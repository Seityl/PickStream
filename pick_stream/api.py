...
from pick_stream.core import handle_print_request
from pick_stream.core import get_printers
...
@frappe.whitelist()
@pick_stream_validate(methods=['GET'])
def submit_print_request(item_type:str, user:str, mr_name:str, printer:str) -> dict:
    """Prints label based on params"""
    try:
        print_request = handle_print_request(item_type, user, mr_name, printer)
