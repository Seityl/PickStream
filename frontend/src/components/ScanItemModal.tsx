...
export default function ScanItemModal({itemCode, itemBarcode, setItemBarcode, validateBarcode, itemIsValidated, submitScan, closeModal}: any) {
  ...
  return (
    ...
    <div className="modal">
      ...
      <div className="flex flex-col items-center modal-content">
        ...
        <label htmlFor="close_crate" className='flex flex-row self-start mt-1 mb-2'>
        ...
        <button className="modal-btn" type="submit" onClick={() => submitScan(scannedQuantity, 'crate', closeCrate)}>
          Submit Scan
        </button>
