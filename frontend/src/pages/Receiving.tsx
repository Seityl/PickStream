...
// import {getReceivingCrateList} from '../../utils/api';
  ...
  return (
    <main className='min-h-screen'>
      <header className='flex flex-row items-center px-4 py-6 bg-[#171717] text-white'>
            ...
            <p className='mx-auto text-xl font-semibold'>Goods Incoming</p>
      </header>
...
//   console.log('receiving loader - ', user);
//   const receivingCrateList = await getReceivingCrateLis(user!);
//   console.log('receiving crate list -',  receivingCrateList);
//   return  receivingCrateList
